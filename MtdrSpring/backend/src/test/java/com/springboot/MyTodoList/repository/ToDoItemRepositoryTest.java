...
class ToDoItemRepositoryTest {
    ...
    void saveAndFindByIdShouldWork() {
        ...
        item.setDescription("Prepare repository test evidence");
        item.setDone(false);
        item.setCreation_ts(OffsetDateTime.parse("2026-04-08T10:30:00Z"));
        ...
        assertThat(foundItem.get().getDescription()).isEqualTo("Prepare repository test evidence");
