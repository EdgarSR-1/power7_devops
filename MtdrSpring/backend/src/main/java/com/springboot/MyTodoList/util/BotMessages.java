...
public enum BotMessages {
	...
	SPRINTS_FORMAT("Format: /sprints to list all sprints\nUse /createsprint name|yyyy-MM-dd HH:mm|yyyy-MM-dd HH:mm to create one\nExample: /createsprint Sprint 5|2026-04-15 09:00|2026-04-29 18:00"),
	NO_SPRINTS_FOUND("No sprints found. Create one with /createsprint name|yyyy-MM-dd HH:mm|yyyy-MM-dd HH:mm"),
	SPRINT_CREATED("Sprint created successfully: %s (#%s)"),
	CREATE_SPRINT_FORMAT("Format: /createsprint name|yyyy-MM-dd HH:mm|yyyy-MM-dd HH:mm\nExample: /createsprint Sprint 5|2026-04-15 09:00|2026-04-29 18:00"),
